  ...
  <div>
    <ul>
      <li class="mt-2" v-for="item in gamesStat" :key="item.gameId">
        <h1 class="w-full text-center text-2xl font-semibold">Game {{ item.gameId + 1 }}</h1>
        ...
        <div class="mt-2 flex w-full">
          <div class="grid flex-grow content-start w-1/2">
            ...
            <div class="w-full grid justify-items-end">
              <div class="py-3 w-5/12 bg-base-300 rounded-box align-middle text-center text-3xl font-mono">{{
                item.score.teamA
              }}</div>
            </div>
